...
struct qt_meta_stringdata_CLASSMatchWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMatchWidgetENDCLASS = QtMocHelpers::stringData(
    "MatchWidget",
    "on_ajouterMatch_clicked",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMatchWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MatchWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMatchWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMatchWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMatchWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MatchWidget, std::true_type>,
        // method 'on_ajouterMatch_clicked'
...
void MatchWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_ajouterMatch_clicked(); break;
        ...
        case 2: _t->on_recherche_textChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 3: _t->on_tri_currentIndexChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *MatchWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMatchWidgetENDCLASS.stringdata0))
